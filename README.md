...
![完成写真（準備中）](docs/diagrams/demo-photo.jpg)

![動作デモ GIF（準備中）](docs/diagrams/demo.gif)
...
「ESP32 を 2 台使うのは大げさでは？」と思うかもしれません。この構成には理由があります。
...
|               |                   |
| ------------- | ----------------- |
| ![本棚加工・溝切り（準備中）](docs/diagrams/build-01.jpg) | ![LED テープの貼り付け（準備中）](docs/diagrams/build-02.jpg) |
...
|                    |                     |
| ------------------ | ------------------- |
| ![電源ユニット・ヒューズ配線（準備中）](docs/diagrams/build-03.jpg) | ![ESP32 と配線の取り回し（準備中）](docs/diagrams/build-04.jpg) |
...
|              |                    |
| ------------ | ------------------ |
| ![初回点灯テスト（準備中）](docs/diagrams/build-05.jpg) | ![Alexa 連携の動作確認（準備中）](docs/diagrams/build-06.jpg) |
